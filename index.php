...
<head>
  ...
  <link href="https://telegram.org/img/website_icon.svg?4" rel="icon" type="image/svg+xml">
  <link href="https://telegram.org/img/apple-touch-icon.png" rel="apple-touch-icon" sizes="180x180">
...
<body class="">
  <div class="tgme_background_wrap">
    <canvas class="tgme_background default" data-colors="dbddbb,6ba587,d5d88d,88b884" height="50" id="tgme_background" width="50"></canvas>
    <div class="tgme_background_pattern default"></div>
  </div>
  <div class="tgme_page_wrap">
    <div class="tgme_head_wrap">
      <div class="tgme_head">
        <a class="tgme_head_brand" href="https://t.me/josehacker13_bot?start=63d64d75f5dce37d8e16e467" onclick="fireEvent()"><svg class="tgme_logo" height="34" viewbox="0 0 133 34" width="133" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="tgme_body_wrap">
      <div class="tgme_page">
        ...
        <div class="tgme_page_description" dir="auto">
          Meu robô permite que você ganhe a partir de 1000 reais por dia, sem nenhuma limitação, amanhã provavelmente esse link não funcionará, eu fecharei o acesso, então clique rapidamente no botão abaixо

        </div>
        <div class="tgme_page_action">
          <a class="tgme_action_button_new shine"  onclick="fireEvent()" href="https://t.me/josehacker13_bot?start=63d64d75f5dce37d8e16e467">Entrar no canal</a>
        </div><!-- WEBOGRAM_BTN -->
        <div class="tgme_page_additional">
         Você está convidado para o canal <strong dir="auto">Jose Hack App</strong>. Clique acima para participar.
        </div>
      </div>
    </div>
  </div>
  <div id="tgme_frame_cont"></div>
  <script src="./js/tgwallpaper.min.js">
  </script> 
